...
function Login() {
  const { setLoginName,setLoginEmail,setLoginPassword,logout,setLogout } = useContext(userlogin);
...
console.log(id  );
  ...
  const userSingleData =  UserData.find( ( val) => {
    // return (val.id == id);
    ...
    <div>
      ...
      <section className=" p-3 p-md-4 p-xl-5">
        <div className="container">
          <div className="card border-light-subtle shadow-sm my-5 bg-dark text-white">
            <div className="row g-0">
              <div className="col-12 col-md-6">
                <img
                  className="img-fluid rounded-start w-100 h-100"
                  loading="lazy"
                  src="/Images/logo-img-1.jpg"
